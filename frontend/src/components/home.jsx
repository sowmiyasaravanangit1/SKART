      ...
      {/* Navbar */}
        ...
        <div className="relative">
          <button onClick={() => setMenuOpen(!menuOpen)}>
            <FaHome size={30} className="text-violet-900" />
          </button>

          {/* Dropdown Menu */}
          {menuOpen && (
            <div className="absolute top-10 left-0 bg-white shadow-lg rounded p-2 w-40">
              <button
                onClick={() => navigate("/")}
                className="block w-full text-left px-2 py-1 hover:bg-violet-100"
              >
                Home
              </button>
              <button
      ...
      <div className="flex flex-row justify-between items-center p-4 relative">
        ...
        <div>
          ...
          <button
            ...
            className="text-white bg-violet-900 px-4 py-1 ml-2"
          >
            Register
          </button>
        </div>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-violet-900 text-6xl">
          <h1 className="bg-white text-violet-900">
            India's fastest delivery to your door step
          </h1>
        </div>
      </div>
