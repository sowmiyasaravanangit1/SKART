           ...
           <div className = "absolute inset-0 flex items-center justify-center text-violet-900 text-lg p-8">
            ...
            <form className=" bg-white px-12 py-6" >
                ...
                <input type= "text" name = "Password " placeholder="Enter your 
                 Password" className = "border-2 p-1 border-violet-900 rounded w-[300px]"/> <br/>
                <label  className> Confirm Password </label> <br/>
                <input type= "text" name = "Confirm Password " placeholder="Enter your Confirm Password" className = "border-2 p-1 border-violet-900 rounded w-[300px]"/> <br/> <br/>
